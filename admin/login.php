                    ...
                    <div class="card">
                        <div class="row">
                            <div class="col-md-4 pe-md-0">
                                <div style="width:100%;
height:452px;
object-fit:cover" class="auth-side-wrapper">
                                    <img style="width:100%;
height:100%;" src="resimler/login_resimler/resim3.jpg">

                                </div>
                            </div>
                            <div class="col-md-8 ps-md-0">
                                <div class="auth-form-wrapper px-4 py-5">
                                    <a href="#" class="noble-ui-logo d-block mb-2">Buta <span>Elektromekanik A.Ş.</span></a>
